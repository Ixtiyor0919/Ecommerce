function Filterplar(props) {
  return (
    <div className="bg-white  rounded-[6px] w-[126px] h-[40px] flex justify-center items-center space-x-[8px]">
      <svg
        width="16"
        height="16"
        viewBox="0 0 16 16"
      ...
      <div>
        <p className="text-myBlack text-sm font-normal ">Фильтры</p>
        {/* <Filterplar /> */}
      </div>
    </div>
  );
